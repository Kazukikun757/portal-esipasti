    ...
    public function updateOrder()
    {
        if ($this->request->isAJAX()) {
            ...
            if (!empty($positions)) {
                ...
                // Check if updateOrder method exists in the model
                if (method_exists($this->menuModel, 'updateOrder')) {
                    ...
                    foreach ($orderData as $id => $order) {
                        $this->menuModel->update($id, ['order' => $order]);
                    }
            ...
            return $this->response->setJSON([
                ...
                'debug'   => [
                    ...
                    'dbError'   => $this->menuModel->errors() ?: $db->error(),
                ]
            ]);
        }
