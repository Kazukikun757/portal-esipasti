...
<body class="theme-style--light">
    ...
    <main class="wrapper">
        ...
        <!-- About Kimono -->
        <section class="wptb-about-one bg-image-4 pb-0" style="background-image: url('../assets/img/more/texture.png'); background-position: 80%;">
            <div class="container">
                <div class="wptb-heading">
        ...
        <!-- Services -->
        <section class="wptb-services-one bg-image-2">
                    ...
                    <div class="wptb-item--inner">
                        <div class="row align-items-center">
                            <div class="col-lg-6">
                                ...
                                <h1 class="wptb-item--title">Our Photography <br>
                                    <span>Services</span>
                                </h1>
                            </div>
                ...
                <div class="row">
                        ...
                        <div class="wptb-icon-box5 mb-3">
                            <div class="wptb-item--inner">
                                <div class="wptb-item--icon">
                                    <img src="../assets/img/services/icon-1-2.svg" alt="img" class="default-icon">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 ps-0 wow fadeInLeft">
                        <div class="wptb-icon-box5 mb-3">
                            <div class="wptb-item--inner">
                                <div class="wptb-item--icon">
                                    <img src="../assets/img/services/icon-2-2.svg" alt="img" class="default-icon">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 ps-0 wow fadeInLeft">
                        <div class="wptb-icon-box5 mb-3">
                            <div class="wptb-item--inner">
                                <div class="wptb-item--icon">
                                    <img src="../assets/img/services/icon-3-2.svg" alt="img" class="default-icon">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 ps-0 wow fadeInLeft">
                        <div class="wptb-icon-box5 mb-3">
                            <div class="wptb-item--inner">
                                <div class="wptb-item--icon">
                                    <img src="../assets/img/services/icon-4-2.svg" alt="img" class="default-icon">
        ...
        <!-- BG Video -->
        <div class="container">
            <div class="wptb-video-player1 wow zoomIn mr-bottom-70 bg-image" style="background-image: url('../assets/img/background/bg-1.jpg');">
                <div class="wptb-item--inner">
                    <div class="wptb-item--holder">
            ...
            <div class="container">
                <div class="wptb-heading">
                    <div class="wptb-item--inner">
                        <div class="row">
                            <div class="col-lg-6">
                                <h6 class="wptb-item--subtitle"><span>03 //</span> Our Team</h6>
                        ...
                        <div class="swiper-slide">
                            <div class="wptb-team-grid1">
                                <div class="wptb-item--inner">
                                    ...
                                    <div class="wptb-item--holder">
                                        <div class="wptb-item--meta">
                                            <h5 class="wptb-item--title">Watson Gill</h5>
                                            <p class="wptb-item--position">Photographer</p>
                                        </div>
                                        <div class="wptb-item--social">
                                            <a href="#">FB</a>
                    ...
                    <div class="grid grid-3 gutter-10 clearfix">
                        ...
                        <div class="grid-item">
                            <div class="wptb-item--inner">
                                ...
                                <div class="wptb-item--holder">
                                    <div class="wptb-item--meta">
                                        <h4><a href="project-details.html">Bright Boho Sunshine0</a></h4>
                                        <p>By Jonathon Willson</p>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="container">
                <div class="wptb-heading">
                    <div class="wptb-item--inner">
                        <div class="row align-items-center">
                            <div class="col-lg-6">
                                <h6 class="wptb-item--subtitle"><span>05 //</span> Latest News</h6>
                            ...
                            <div class="wptb-icon-box1 wow fadeInLeft">
                                <div class="wptb-item--inner flex-start">
                                    ...
                                    <div class="wptb-item--holder">
                                        ...
                                        <p class="wptb-item--description">www.kimonophotography.com</p>
                                        <a href="www.kimonophotography.com" class="wptb-item--link">Visit Now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="wptb-icon-box1 wow fadeInLeft">
                                <div class="wptb-item--inner flex-start">
                                    ...
                                    <div class="wptb-item--holder">
                                        ...
                                        <p class="wptb-item--description">+123 455 987 994</p>
                            ...
                            <div class="wptb-icon-box1 wow fadeInLeft">
                                <div class="wptb-item--inner flex-start">
                                    ...
                                    <div class="wptb-item--holder">
                                        ...
                                        <p class="wptb-item--description">13 Madison Street, NY, USA</p>
